...
public class BrandResponse {
    ...
    public BrandResponse parseBrand() {
        ...
        try {
            ...
            LogUtility.infoLog("[BRAND RESPONSE] Brand ID: " + this.brandModel.getId() + ", Name: " + this.brandModel.getName());
            return this;
        } catch (Exception e) {
    ...
    public BrandResponse validateCreate() {
        ...
        Assert.assertEquals(this.statusCode, ResponseStatusType.RESPONSE_CREATED, "Expected 201 but got " + this.statusCode);
        parseBrand();
    ...
    public BrandResponse validateGet() {
        ...
        Assert.assertEquals(this.statusCode, ResponseStatusType.RESPONSE_OK, "Expected 200 but got " + this.statusCode);
        parseBrand();
    ...
    public BrandResponse validateDelete() {
        ...
        Assert.assertEquals(this.statusCode, ResponseStatusType.RESPONSE_NO_CONTENT, "Expected 204 but got " + this.statusCode);
    ...
    public BrandResponse validateNotFound() {
        ...
        Assert.assertEquals(this.statusCode, ResponseStatusType.RESPONSE_NOT_FOUND, "Expected 404 but got " + this.statusCode);
